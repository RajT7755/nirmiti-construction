...
import { readLogoDataUrl } from "@/lib/branding/defaultBrand";
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 space-y-6">
        ...
        <div className="flex flex-wrap items-start gap-6 border-b border-gray-100 pb-6">
          <img
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1 mb-3">PNG or JPEG. Used on sidebar, login, and invoices.</p>
            {isEditing && (
